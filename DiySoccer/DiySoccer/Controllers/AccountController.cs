...
using DiySoccer.Models;
using Interfaces.Users.DataAccess;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;
using SignInStatus = Authentication.SignInStatus;
...
namespace DiySoccer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result =
                await
                    SignInHelper.PasswordSignIn(model.Email, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> VerifyCode(string provider, string returnUrl)
        {
            ...
            return
                View(new VerifyCodeViewModel { Provider = provider, ReturnUrl = returnUrl });
        }
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            var result =
                await
                    SignInHelper.TwoFactorSignIn(model.Provider, model.Code, isPersistent: false,
