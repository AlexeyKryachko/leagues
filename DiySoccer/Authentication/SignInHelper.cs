...
namespace Authentication
{
    /*public class SignInHelper
    {
        ...
        public AuthenticationUserManager UserManager { get; private set; }
        public IAuthenticationManager AuthenticationManager { get; private set; }

        public async Task SignInAsync(UserAuthDb user, bool isPersistent, bool rememberBrowser)
        {
        ...
        private async Task<SignInStatus> SignInOrTwoFactor(UserAuthDb user, bool isPersistent)
        {
